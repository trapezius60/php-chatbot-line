...
curl_setopt_array($curl, array(
  CURLOPT_URL => "api.airvisual.com/v2/city?city=Nakhon%20Ratchasima&state=Nakhon%20Ratchasima&country=Thailand&key=08f5ea70-e3e7-402d-8676-ce6734e5bbb8", //หมดอายุ 1 ปี นับจาก ตค 63
...
$arr = json_decode($response, true);
	...
	$recommendGood = " 😃*ข้อแนะนำ:: คุณภาพอากาศดี ควรเปิดหน้าต่างบ้านเพื่อรับอากาศดีเข้ามา ใช้ชีวิตกลางแจ้งและออกกำลังกายได้ตามปกติ*  ";
	$recommendMod = " 😐*ข้อแนะนำ:: คุณภาพอากาศเริ่มแย่ มีผลกระทบกับบุคคลที่เป็นภูมิแพ้หรือโรคทางเดินหายใจ (sensitive individuals) ควรปิดหน้าต่างบ้านป้องกันอากาศที่มีมลพิษเข้า บุคคลที่เป็นภูมิแพ้อากาศควรหลีกเลี่ยงการอยู่นอกอาคาร ลดการทำกิจกรรมและออกกำลังกายกลางแจ้ง หากอยู่นอกอาคารควรใส่หน้ากากอนามัย*  ";
	$recommendSevere = " 😒😷**ข้อแนะนำ:: คุณภาพอากาศมีมลพิษมากมีผลกระทบกับบุคคลทั่วไป อยู่นอกอาคารควรใส่หน้ากากอนามัย ลดออกกำลังกายและกิจกรรมกลางแจ้ง และเปิดเครื่องฟอกอากาศในอาคาร** ";
	$recommendUnhealthy = " 😨😷***ข้อแนะนำ:: คุณภาพอากาศเริ่มทำให้สุขภาพคนทั่วไปแย่ลง งดออกกำลังกลางแจ้ง ใส่หน้ากากอนามัยตลอดเวลาเมื่ออยู่นอกบ้าน*** ";
	$recommendHazadous = " 😱😷****ข้อแนะนำ:: คุณภาพอากาศแย่มาก ห้ามออกกำลังกายกลางแจ้ง ใส่หน้ากากอนามัยตลอดเวลาที่อยู่นอกบ้าน ควรปิดหน้าต่างและประตูให้มิดชิด เปิดเครื่องฟอกอากาศ**** ";
//ต้องเรียงจากมากไปน้อย ถ้าน้อยไปมากจะออกแค่ recommendMod	
if ($arr[data][current][pollution]['aqius'] >"300") {
...
} elseif ($arr[data][current][pollution]['aqius'] <"51") {
